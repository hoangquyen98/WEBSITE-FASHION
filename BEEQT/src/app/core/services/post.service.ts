...
export class PostsService {
  ...
  updatePost(idPost: string, titlePost: string, contentPost: string, datePost: string, imagePost: File | string) {
    let postData: Post | FormData;
    // const datePost = stringfy(Date.now());
    if (typeof imagePost === 'object') {
      postData = new FormData();
      postData.append('id', idPost);
      postData.append('title', titlePost);
      postData.append('content', contentPost);
      // postData.append('date', datePost);
